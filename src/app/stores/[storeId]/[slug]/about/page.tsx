        ...
        <nav className="navbar navbar-expand-lg navbar-dark navbar-theme">
          <div className="container">
            ...
            <div className="navbar-nav ms-auto">
              ...
              <Link href={`/stores/${store.id}/${storeSlug}/about`} className="nav-link active">About</Link>
              <Link href={`/stores/${store.id}/${storeSlug}/contact`} className="nav-link">Contact</Link>
            </div>
          </div>
        </nav>
          ...
          <div className="row">
            <div className="col-lg-8 mx-auto">
              ...
              <div className="text-center">
                <Link href={`/stores/${store.id}/${storeSlug}`} className="btn btn-theme btn-lg me-3">
                  Shop Now
                </Link>
                <Link href={`/stores/${store.id}/${storeSlug}/contact`} className="btn btn-outline-secondary btn-lg">
                  Contact Us
                </Link>
              </div>
            </div>
